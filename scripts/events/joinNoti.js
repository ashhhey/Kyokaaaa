...
module.exports.run = async function({ api, event }) {
	...
	if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
		...
		return api.sendMessage(`${global.config.BOTNAME} ⭕𝘾𝙤𝙣𝙣𝙚𝙘𝙩𝙚𝙙 𝙎𝙪𝙘𝙘𝙚𝙨𝙨𝙛𝙪𝙡𝙡⭕
𝙏𝙝𝙖𝙣𝙠 𝙮𝙤𝙪 𝙛𝙤𝙧 𝙪𝙨𝙞𝙣𝙜 ${global.config.BOTNAME} 𝘽𝙤𝙩, 𝙐𝙨𝙚 𝙘𝙖𝙡𝙡𝙖𝙙 𝙘𝙤𝙢𝙢𝙖𝙣𝙙 𝙞𝙛 𝙮𝙤𝙪 𝙚𝙣𝙘𝙤𝙪𝙣𝙩𝙚𝙧 𝙨𝙤𝙢𝙚 𝙚𝙧𝙧𝙤𝙧!`, threadID);
	}
	else {
		try {
    const request = require("request");
...
memLength.sort((a, b) => a - b);
			...
			(typeof threadData.customJoin == "undefined") ? msg = "𝗪𝗲𝗹𝗰𝗼𝗺𝗲 𝘂𝘀𝗲𝗿!, {uName}\n┌────── ～●～ ──────┐\n----- 𝗪𝗲𝗹𝗰𝗼𝗺𝗲 𝘁𝗼 {threadName} -----\n└────── ～●～ ──────┘\n𝗠𝘆 𝗼𝘄𝗻𝗲𝗿 𝘀𝗮𝗶𝗱:\n𝗧𝗵𝗲 𝗿𝘂𝗹𝗲 𝗶𝘀 𝘃𝗲𝗿𝘆 𝘀𝗶𝗺𝗽𝗹𝗲 𝗻𝗼 𝘀𝗽𝗮𝗺𝗺𝗶𝗻𝗴 𝗮𝗻𝗱 𝗱𝗼𝗻𝘁 𝘀𝗮𝘆 𝗯𝗮𝗱𝘄𝗼𝗿𝗱𝘀, 𝗶𝗳 𝘀𝗼𝗺𝗲𝗼𝗻𝗲 𝗲𝗻𝗰𝗼𝘂𝗻𝘁𝗲𝗿 𝗮𝗻 𝗲𝗿𝗿𝗼𝗿 𝗶𝗻 𝘁𝗵𝗶𝘀 𝗯𝗼𝘁 𝗷𝘂𝘀𝘁 𝗰𝗼𝗻𝘁𝗮𝗰𝘁 𝗺𝗲 𝗵𝗲𝗿𝗲[https://www.facebook.com/kyouya.developer].\n𝗧𝘆𝗽𝗲 /help\n𝗬𝗼𝘂'𝗿𝗲 𝘁𝗵𝗲 {soThanhVien}th 𝗺𝗲𝗺𝗯𝗲𝗿 𝗼𝗳 𝘁𝗵𝗶𝘀 𝗴𝗿𝗼𝘂𝗽, 𝗽𝗹𝗲𝗮𝘀𝗲 𝗲𝗻𝗷𝗼𝘆 🧸" : msg = threadData.customJoin;
			msg = msg
